  ...
  en: {
    translation: {
      ...
      investment: {
        ...
        highlight: "Be Part of the Change: Supply Global Perlite Demand from Mexico's Leading Mine",
  ...
  es: {
    translation: {
      ...
      investment: {
        ...
        highlight: "Sé Parte del Cambio: Abastece la Demanda Global de Perlita desde la Mina Líder de México",
