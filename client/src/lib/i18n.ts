  ...
  en: {
    translation: {
      nav: {
        whoWeAre: "Who We Are",
        location: "Location",
        about: "More Than a Mine",
        whatIsPerlite: "What is Perlite?",
        mineralFuture: "The mineral of the future",
  ...
  es: {
    translation: {
      nav: {
        ...
        location: "Ubicación",
        about: "Más que una Mina",
        whatIsPerlite: "¿Qué es la Perlita?",
        mineralFuture: "El mineral del futuro",
